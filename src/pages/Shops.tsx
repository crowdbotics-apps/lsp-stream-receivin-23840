...
export default function Shops({navigation}: StackScreenProps<{ Profile: any }>) {
		...
		return (
			<TouchableOpacity
				...
				<View style={styles.itemWrapper}>
					<Image source={item.shopLogoUrls.primaryShopLogoUrl} style={styles.itemImage}/>
		...
		<SafeAreaView style={{flex: 1, backgroundColor: R.Colors.WHITE}}>
			<TouchableWithoutFeedback
				...
				<View style={styles.container}>
					...
					<View style={styles.container}>
						<Text style={styles.title}>Welcome to <Text style={styles.titleBold}>Live Sale Pro</Text></Text>
						<Text style={styles.description}>Select Store</Text>
